...
class ClassSizeCatalog extends java.util.Hashtable
{
    ClassSizeCatalog()
    {
        ...
        put( "org.apache.derby.iapi.types.CollatorSQLLongvarchar", new int[]{4,10});
        put( "org.apache.derby.iapi.types.DataType", new int[]{0,2});
        put( "org.apache.derby.iapi.types.SQLInteger", new int[]{8,2});
        put( "org.apache.derby.impl.store.access.btree.index.B2I", new int[]{36,6});
        put( "org.apache.derby.iapi.types.BinaryDecimal", new int[]{4,3});
        put( "org.apache.derby.impl.store.access.btree.BTree", new int[]{24,6});
        put( "org.apache.derby.iapi.types.SQLChar", new int[]{4,9});
        put( "org.apache.derby.iapi.types.SQLTinyint", new int[]{5,2});
        put( "org.apache.derby.iapi.types.CollatorSQLChar", new int[]{4,10});
        put( "org.apache.derby.iapi.types.SQLTime", new int[]{8,3});
        put( "org.apache.derby.iapi.types.SQLClob", new int[]{4,11});
        put( "org.apache.derby.iapi.types.SQLBinary", new int[]{4,5});
        put( "org.apache.derby.iapi.types.SQLVarchar", new int[]{4,9});
        put( "org.apache.derby.iapi.types.SQLVarbit", new int[]{4,5});
        ...
        put( "org.apache.derby.iapi.types.CollatorSQLClob", new int[]{4,12});
        ...
        put( "org.apache.derby.iapi.types.CollatorSQLVarchar", new int[]{4,10});
        ...
        put( "org.apache.derby.impl.store.access.btree.index.B2I_v10_2", new int[]{36,6});
        ...
        put( "org.apache.derby.impl.store.access.btree.index.B2I_10_3", new int[]{36,6});
