...
public class InternalTriggerExecutionContext implements TriggerExecutionContext, ExecutionStmtValidator
{
	...
	** results.
	*/
	private FastTable	resultSetFastTable;

	/**
	 * aiCounters is a FastTable of AutoincrementCounters used to keep state which
	...
	/**
	 * aiHT is a FastMap of autincrement <key, value> pairs. This is used for
	 * ai values generated by the trigger.
	 */
	private FastMap aiHT;
	 ...
	 *		fired
	 * @param aiCounters		A FastTable of AutoincrementCounters to keep state
	...
	) throws StandardException
	{
		...
		this.resultSetFastTable = new FastTable();
	...
	{
		// first search the FastMap-- this represents the ai values generated
		// by this trigger.
		if (aiHT != null)
			{
		...
		// If we didn't find it in the FastMap search in the counters which
	 ...
	 * execution context FastMap of autoincrement values.
	 */
